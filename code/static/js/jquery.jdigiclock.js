...
(function($) {
    $.fn.extend({
        ...
        jdigiclock: function(options) {
            ...
            return this.each(function() {
                ...
                html    += '<p id="left_arrow"><img src="/static/media/digiclock/icon_left.png" /></p>';
                html    += '<p id="right_arrow"><img src="/static/media/digiclock/icon_right.png" /></p>';
    ...
    $.fn.getWeather = function(el) {
        ...
        el.find('#weather').html('<p class="loading"></p>');
